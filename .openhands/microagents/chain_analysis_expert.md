...
description: "Simplifies on-chain analysis for addresses. Given an address you get: where funds came from, where they went, what the address did (DeFi interactions, contracts), risks, explorer links. Ideal for audits, debugging, contract tracing on Ethereum/PulseChain."
triggers:
- chain analysis
- analyze address
- wallet trace
